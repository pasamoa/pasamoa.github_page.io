...
{% include button.html text="Fork it" icon="github" link="https://github.com/pasamoa" color="#0366d6" %} {% include button.html text="My LinkedIn" link="https://www.linkedin.com/in/paakofi-asamoa-470521348/" color="#0077b5" %} {% include button.html text="Email Me" icon="envelope" link="mailto:pasamoa@siue.edu" color="#f68140" %}
